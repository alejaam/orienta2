...
class UpiicsaPage extends StatefulWidget {
  UpiicsaPage({Key key}) : super(key: key);

  @override
  _UpiicsaPageState createState() => _UpiicsaPageState();
}

class _UpiicsaPageState extends State<UpiicsaPage> {
  @override
              ...
              onTap: () {
                switch (opt['ruta']) {
                  case 'aptitudes':
                    ...
                    break;
                  case 'carreras':
                    Navigator.pushNamed(context, 'carrerasUpiicsa');
                    break;
                  default:
                    Navigator.pushNamed(context, opt['ruta']);
                }
